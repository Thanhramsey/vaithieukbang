...
<section id="content">
		<div class="container" style="margin-top:50px">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align:right">
					<a href="<?php echo base_url() ?>sanpham" class="btn btn-green btn-large btn-rounded">Trờ về</a>
			</div>
								...
								<div class="col-md-8  wow fadeIn" data-wow-duration="1s" data-wow-delay=".6s">
									<div class="product-view-content">
										...
										<div style="margin-top: 10px;">
											<p><b>Đặt hàng gọi ngay: </b> <span style="color:red"><strong>0376695104</strong></span></p>
										</div>
