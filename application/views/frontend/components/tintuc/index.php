...
<a class="nav-link " href="<?php echo  base_url()."thuvien"; ?>">Hình ảnh</a>
        ...
        <section id="ourblog" class="blog-banner">
            <div class="container text-center text-md-right">
                ...
                <p class="font-weight-normal"><a class="text-white">Home</a> / <span class="main-color">Blog</span></p>
                    ...
                    <div class="col-md-4 mb-2">
                        <div class="blog-panel">
                            ...
                            <div class="panel-img"><img
                                    src="<?php echo base_url() ?>public/images/posts/<?php echo $item['img']; ?>"
                                    alt="img"></div>
                            <p><?php echo $item['introtext']; ?></p>
                            <div class="img-link"><img
                                    src="<?php echo base_url() ?>/public/restaurant/img/testimonial-1.png"
                                    alt="img"><span class="name-link">by:
                                    <span><a href="blog-left.html">Thien Dinh Tue</a></span> </span> </div>
                            <p class="mb-3"><?php echo $item['created']; ?><span></span></p>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
