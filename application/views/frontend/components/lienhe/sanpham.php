...
<body data-spy="scroll" data-target=".navbar" data-offset="90" class="position-relative">
    ...
    <section class="position-relative p-0 no-transition" id="home">
                ...
                <ul>
                    ...
                    <li data-index="rs-44" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        <div class="tp-caption   tp-resizeme" id="slide-44-layer-2"
                            ...
                            data-fontsize="['30','26','28','23']" data-lineheight="['46','46','38','33']"
        ...
        <ul class="social-icons-simple revicon darkcolor">
            ...
            <li class="d-table"><a class="linkedin-text-hvr" href="javascript:void(0)"><i
            ...
            <div class="row">
                <div class="col-12 col-md-10 col-lg-8 offset-md-1 offset-lg-2 text-center wow fadeIn"
                    ...
                    <div class="d-inline-block">
                        <h1 class="title main-font text-main my-5 text-gradient"><strong>Sản phẩm của chúng tôi</strong>
                        </h1>
            ...
            <div class="row m-0">
                ...
                <div class="col-md-3 items graphic">
                        ...
                        <a href="<?php echo base_url() ?>ttsanpham/<?php echo $sp['id']; ?>">
                            ...
                            <div class="item-img-overlay valign">
                                <div class="overlay-info text-center">
                                    ...
                                    <?php if($sp['price']==0): ?>
                                    <p class="text-white">Giá: Liên Hệ !</p>
                                    <?php else : ?>
                    ...
                    <div class=" mt-3 mb-3 text-center">
                        <a href="<?php echo base_url() ?>ttsanpham/<?php echo $sp['id']; ?>"> <strong>Chi tiết
                            </strong></a>
                    </div>
                </div>
                <!-- </div> -->
            ...
            <div class="row pb-0">
                <div class="col-md-6">
                    <div class="contact">
                        ...
                        <div class="icon-flex">
                            <p class="contact-detail mb-3"><i class="fa fa-home contact-icon"></i> 214 Quang Trung, Tổ
                                Dân Phố 7, K'Bang, Gia Lai</p>
                        </div>
                        <p class="contact-detail"><i class="fa fa-clock contact-icon"></i> Thứ 2 - Thứ 7: 9:00am-6:00pm
                        </p>
                        <p class="contact-detail"><i class="fa fa-envelope-open contact-icon"></i>
                            vaihtxtienphongkbang.com.vn</p>
                    ...
                    <form class="contact-form" id="contact-form-data">
                        <div class="row">
                            <div class="col-sm-12" id="result">
                                <h6 class="text-success" style="display:none">Thông tin của bạn đã được lưu lại , chúng
                                    tôi sẽ liên lạc lại với bạn sớm nhất.</h6>
                            </div>
                            <div class="col-md-12 mb-3">
                                <input class="form-control m-mb-20" type="text" placeholder="Tên" required="" id="name"
                                    name="userName">
                            </div>
                            <div class="col-md-12 mb-3">
                            ...
                            <div class="col-md-12 mb-3">
                                <input class="form-control m-mb-20" type="text" placeholder="Số điện thoại" required=""
                                    id="phone" name="phone">
                            </div>
