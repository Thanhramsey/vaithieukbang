        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="about-store">
                 Nhân Mobile. Chất lượng - giá cả hợp lý
             </div>
         </div>
         <div class="col-xs-12 col-sm-6">
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span>75 Phạm Hùng, Tân Sơn , Gia Lai</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-phone"></i>
                        <span>0704.7777.81 - 0899.39.16.39</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-envelope"></i>
                        <span><a href="mailto:vanhiepp1998@gmail.com">nhanmobile1996@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        </div>
